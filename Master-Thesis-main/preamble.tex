...
% MD: i titoli lunghi sforano il margine destro nel layout finale A4
% ("Electromagnetic Trapping of Neutral Atoms" di 39 pt, "From Conventional to
% Hollow-Core Optical Fibers" di 20 pt, "Coupling to the Motional ..." di 14 pt).
% Causa: titlesec giustifica le intestazioni. Per azzerarli tutti, sostituire le
% tre righe qui sopra con queste. Verificato: zero overfull sui titoli.
% NB: l'opzione di pacchetto \usepackage[raggedright]{titlesec} NON basta,
% perche' \titleformat* la sovrascrive.
